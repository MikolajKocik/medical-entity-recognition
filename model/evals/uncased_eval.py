...
from model.training.train_uncased import (
    args,
    compute_metrics,
    data_collator,
...
model_dir = Path(__file__).resolve().parents[1] / "saved" / "un-ner.model"
...
def main():
    ...
    plt.ylim(0, 1.1)
    plt.title(
        'NER uncased evaluation results', fontsize=13, fontweight='bold', pad=15
    )
    ...
    save_dir = Path(__file__).resolve().parent / "uncased_plots"
